...
\begin{figure}[h]
\centering
\includegraphics[width=0.65\textwidth]{hist_occurence_lexique.png}
\caption{Distribution des hapax dans le corpus}
\end{figure}
On peut remarquer que depuis le graphe que les thérapeutes vont oser exprimer beaucoup plus souvent des termes liées à notre dictionnaire,
...
\subsubsection{Résultats\protect\footnote[1]{à noter que les thèmes décrit pour les patients et thérapeutes sont des observations visuelles et non généré par le modèle, celui-ci génère uniquement les groupes de mots.}}
