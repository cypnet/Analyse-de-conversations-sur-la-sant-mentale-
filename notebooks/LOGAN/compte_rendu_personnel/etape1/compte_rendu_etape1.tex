...
\textbf{avec les stopwords}, les thérapeutes utilisent plus de mots que les patients (\textbf{28.75\% de plus}) et
\textbf{après lemmatisation}, les thérapeutes utilisent plus de mots que les patients (\textbf{27.29\% de plus}).

  

\subsection{Corrélation patient / thérapeute}

La corrélation entre la longueur du message du patient et celle de la réponse du thérapeute
a été calculée. Le résultat obtenu est une \textbf{corrélation proche de 0} ($\approx 0.05$).

Cela signifie qu'un patient peut s'exprimer longuement et recevoir une réponse courte, et
...
Un \textit{hapax} est un mot qui n'apparaît qu'une seule fois dans le corpus. L'analyse des
mots les moins fréquents a révélé que la plupart des hapax sont du bruit résiduel (abréviations,
artefacts de nettoyage), ce qui confirme l'importance du filtrage préalable.
