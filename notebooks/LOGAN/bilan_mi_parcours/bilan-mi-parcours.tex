...
\begin{tikzpicture}[
  ...
  \node[biggergroup, fit=(methods1) (methods2) (methods3) (methods4) (topic), label=above left:\small\textbf{Étape 1}] (step1) {};
  \node[biggergroup, fit=(sentiment), label=above left:\small\textbf{Étape 2}] (step2) {};
  \node[biggergroup, fit=(conversations) (conversationG1) (conversationG2), label=above left:\small\textbf{Étape 3}] (step3) {};
...
\draw[line width=3pt, color=done] (0,0) -- ({2*(\currentstep-1)},0);
